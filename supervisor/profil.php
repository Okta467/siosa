                  ...
                  <div class="card-body">
                    <form action="profil_ubah.php" method="post">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" id="xalamat" type="text" name="xalamat" value="<?= $supervisor['alamat'] ?? '' ?>" placeholder="Enter alamat" required>
                      </div>
                      ...
                      <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                          ...
                          <input class="form-control" id="xtempat_lahir" type="text" name="xtempat_lahir" value="<?= $supervisor['tempat_lahir'] ?? '' ?>" placeholder="Enter tempat lahir" required>
                        </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <input class="form-control" id="xtanggal_lahir" type="date" name="xtanggal_lahir" value="<?= $supervisor['tanggal_lahir'] ?? '' ?>" required>
                        </div>
                      </div>
