<?php
$user_logged_in = $_SESSION['nama_supervisor'] ?? $_SESSION['nama_guest'] ?? $_SESSION['username'];
$email_user_logged_in = $_SESSION['email'];
$id_supervisor = $_SESSION['id_supervisor'];

$stmt_supervisor = mysqli_stmt_init($connection);

mysqli_stmt_prepare($stmt_supervisor, "SELECT path_to_foto_profil FROM tbl_supervisor WHERE id_supervisor=?");
